...
### Requirements
* Explain the difference between requirements analysis, elicitation, and specification
...
* Understand the advantages an disadvantages of different CI/CD practices
...
### Advanced Topics
* Describe different model customization techniques
* * Apply course topics to real-world scenarios
